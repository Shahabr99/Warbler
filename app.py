...
app.config['SQLALCHEMY_DATABASE_URI'] = (os.environ.get('DATABASE_URL', 'postgresql://ywtljibh:kYsfRozz8ok_JyGRIvokktmRex70vO3i@mahmud.db.elephantsql.com/ywtljibh'))
